...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KoordinatorSchedulerConfiguration) DeepCopyInto(out *KoordinatorSchedulerConfiguration) {
	*out = *in
	...
	if in.TopologyKeyMappings != nil {
		in, out := &in.TopologyKeyMappings, &out.TopologyKeyMappings
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KoordinatorSchedulerConfiguration.
func (in *KoordinatorSchedulerConfiguration) DeepCopy() *KoordinatorSchedulerConfiguration {
	if in == nil {
		return nil
	}
	out := new(KoordinatorSchedulerConfiguration)
	in.DeepCopyInto(out)
	return out
}
